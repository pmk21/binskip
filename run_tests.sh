...
run_experiments() {
    ...
    run_test_binary true 1 1000000 $KEY_RANGE $PCT_GET $PCT_ADD $PCT_REMOVE $CSV_OUT_FILE 5
    run_test_binary false 1 1000000 $KEY_RANGE $PCT_GET $PCT_ADD $PCT_REMOVE $CSV_OUT_FILE 5
